...
var M = (r, e, t) => Ca(r, typeof e != "symbol" ? e + "" : e, t), zt = (r, e, t) => e.has(r) || Cr("Cannot " + t);
var I = (r, e, t) => (zt(r, e, "read from private field"), t ? t.call(r) : e.get(r)), fe = (r, e, t) => e.has(r) ? Cr("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(r) : e.set(r, t), ve = (r, e, t, n) => (zt(r, e, "write to private field"), n ? n.call(r, t) : e.set(r, t), t), V = (r, e, t) => (zt(r, e, "access private method"), t);
import S from "maplibre-gl";
import { Language as Aa, getLanguageInfoFromCode as Ar, config as _t, MapStyle as je, mapStylePresetList as Pt, expandMapStyle as Ta, MapStyleVariant as Ia, ReferenceMapStyle as Ma, toLanguageInfo as Tr, getLanguageInfoFromFlag as Ea, geolocation as Ir } from "@maptiler/client";
import { MapStyle as Ou, MapStyleVariant as Du, ReferenceMapStyle as ju, ServiceError as qu, areSameLanguages as Uu, bufferToPixelDataBrowser as Bu, circumferenceAtLatitude as Vu, coordinates as Gu, data as Hu, elevation as Ku, expandMapStyle as Wu, geocoding as Zu, geolocation as Ju, getAutoLanguage as Yu, getBufferToPixelDataParser as Xu, getLanguageInfoFromCode as Qu, getLanguageInfoFromFlag as ec, getLanguageInfoFromKey as tc, getTileCache as rc, isLanguageInfo as nc, mapStylePresetList as ac, math as oc, misc as ic, staticMaps as sc, styleToStyle as lc, toLanguageInfo as uc } from "@maptiler/client";
import za from "events";
import { v4 as _a } from "uuid";
import { Base64 as Pa } from "js-base64";
const $a = "@maptiler/sdk", Ra = "2.4.2", Na = "The Javascript & TypeScript map SDK tailored for MapTiler Cloud", Fa = "dist/maptiler-sdk.mjs", Oa = "dist/maptiler-sdk.d.ts", Da = "dist/maptiler-sdk.css", ja = "module", qa = {
  ".": {
...
function Mr() {
  ...
  return Array.from(new Set(navigator.languages.map((e) => e.split("-")[0]))).map((e) => Ar(e)).filter((e) => e)[0] ?? E.LOCAL;
}
const H = {
...
class Ya extends za {
   ...
   */
  set apiKey(t) {
    this._apiKey = t, _t.apiKey = t, this.emit("apiKey", t);
  }
  /**
...
const U = new Ya(), { addProtocol: Er } = S, Vt = "localcache_source", Gt = "localcache", Xa = "maptiler_sdk", Qa = 1e3, eo = 100, Ht = typeof caches < "u";
function to(r, e) {
...
let $t;
async function hn() {
  return $t || ($t = await caches.open(Xa)), $t;
}
let zr = 0;
async function ro() {
...
function ao() {
  ...
  if (r === "unavailable" || r === "requested")
    try {
      S.setRTLTextPlugin(H.rtlPluginURL, !0);
    } catch {
    }
}
function oo(r, e) {
...
function _r(r, e) {
  ...
  return t.host === H.maptilerApiHost && (t.searchParams.has("key") || t.searchParams.append("key", U.apiKey), U.session && t.searchParams.append("mtsid", mn)), {
    url: to(t, e)
  };
}
function Pr(r) {
  ...
  const n = structuredClone(r), a = (o) => {
    if (typeof o != "string")
      for (let i = 0; i < o.length; i += 1)
        $r(o[i], t) ? o[i] = structuredClone(e) : a(o[i]);
  };
...
let pl = class extends S.Marker {
  addTo(e) {
    return super.addTo(e);
  }
};
class dl extends S.Popup {
  addTo(e) {
    return super.addTo(e);
  }
}
class yl extends S.Style {
  constructor(e, t = {}) {
    super(e, t);
  }
}
class ml extends S.CanvasSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class hl extends S.GeoJSONSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class gl extends S.ImageSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class vl extends S.RasterTileSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class bl extends S.RasterDEMTileSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class wl extends S.VectorTileSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class Sl extends S.VideoSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class vo extends S.NavigationControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class bo extends S.GeolocateControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class xl extends S.AttributionControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class wo extends S.LogoControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class So extends S.ScaleControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class xo extends S.FullscreenControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class kl extends S.TerrainControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class Ll extends S.BoxZoomHandler {
  constructor(e, t) {
    super(e, t);
  }
}
class Cl extends S.ScrollZoomHandler {
  constructor(e, t) {
    super(e, t);
  }
}
class Al extends S.CooperativeGesturesHandler {
  constructor(e, t) {
    super(e, t);
  }
}
class Tl extends S.KeyboardHandler {
  constructor(e) {
    super(e);
  }
}
class Il extends S.TwoFingersTouchPitchHandler {
  constructor(e) {
    super(e);
  }
}
class Ml extends S.MapWheelEvent {
  constructor(e, t, n) {
    super(e, t, n);
  }
}
class El extends S.MapTouchEvent {
  constructor(e, t, n) {
    super(e, t, n);
  }
}
class zl extends S.MapMouseEvent {
  constructor(e, t, n, a = {}) {
    super(e, t, n, a);
  }
}
...
var ko = 8, Lo = {
  ...
  source_vector: To,
  source_raster: Io,
  source_raster_dem: Mo,
  source_geojson: Eo,
  source_video: zo,
  source_image: _o,
  layer: Po,
  layout: $o,
  layout_background: Ro,
  layout_fill: No,
  layout_circle: Fo,
  layout_heatmap: Oo,
  "layout_fill-extrusion": {
...
const ht = { kind: "null" }, g = { kind: "number" }, A = { kind: "string" }, L = { kind: "boolean" }, ne = { kind: "color" }, _e = { kind: "object" }, C = { kind: "value" }, ci = { kind: "error" }, gt = { kind: "collator" }, vt = { kind: "formatted" }, bt = { kind: "padding" }, Je = { kind: "resolvedImage" }, wt = { kind: "variableAnchorOffsetCollection" };
function W(r, e) {
  return {
    kind: "array",
    itemType: r,
...
const bn = 0.96422, wn = 1, Sn = 0.82521, xn = 4 / 29, Pe = 6 / 29, kn = 3 * Pe * Pe, fi = Pe * Pe * Pe, di = Math.PI / 180, yi = 180 / Math.PI;
function Ln(r) {
...
function Nt(r) {
  return r > fi ? Math.pow(r, 1 / 3) : r / kn + xn;
}
function An([r, e, t, n]) {
  let a = (r + 16) / 116, o = isNaN(e) ? a : a + e / 500, i = isNaN(t) ? a : a - t / 200;
  return a = wn * Ot(a), o = bn * Ot(o), i = Sn * Ot(i), [
    Ft(3.1338561 * o - 1.6168667 * a - 0.4906146 * i),
    // D50 -> sRGB
    Ft(-0.9787684 * o + 1.9161415 * a + 0.033454 * i),
    Ft(0.0719453 * o - 0.2289914 * a + 1.4052427 * i),
    n
  ];
}
function Ft(r) {
...
function Ot(r) {
  return r > Pe ? r * r * r : kn * (r - xn);
}
function mi(r) {
  const [e, t, n, a] = Cn(r), o = Math.sqrt(t * t + n * n);
  return [Math.round(o * 1e4) ? Ln(Math.atan2(n, t) * yi) : NaN, o, e, a];
}
function hi([r, e, t, n]) {
  return r = isNaN(r) ? 0 : r * di, An([t, Math.cos(r) * e, Math.sin(r) * e, n]);
}
function gi([r, e, t, n]) {
  r = Ln(r), e /= 100, t /= 100;
  function a(o) {
...
function vi(r) {
  ...
  if (r.startsWith("rgb")) {
    ...
    if (o) {
      ...
      if (b === "  " || b === "  /" || b === ",," || b === ",,,") {
        const T = [l, p, d].join(""), R = T === "%%%" ? 100 : T === "" ? 255 : 0;
        if (R) {
          const $ = [
            Me(+s / R, 0, 1),
            Me(+c / R, 0, 1),
...
class F {
   ...
   */
  get hcl() {
    return this.overwriteGetter("hcl", mi(this.rgb));
  }
  /**
   * Used in color interpolation.
   *
...
function Ve(r) {
  if (r === null || typeof r == "string" || typeof r == "boolean" || typeof r == "number" || r instanceof F || r instanceof nr || r instanceof ue || r instanceof ae || r instanceof ce || r instanceof he)
    return !0;
  if (Array.isArray(r)) {
    for (const e of r)
      if (!Ve(e))
...
class $e {
  ...
  static parse(e, t) {
    ...
    return a.kind === "array" && a.N === 0 && o && o.kind === "array" && (typeof o.N != "number" || o.N === 0) && (a = o), new $e(a, n);
  }
  evaluate() {
    return this.value;
  }
      ...
      case "color": {
        ...
        for (const a of this.args) {
          ...
          if (typeof t == "string") {
            ...
            if (o)
              return o;
          } else if (Array.isArray(t) && (t.length < 3 || t.length > 4 ? n = `Invalid rbga value ${JSON.stringify(t)}: expected an array containing either three or four numeric values.` : n = Tn(t[0], t[1], t[2], t[3]), !n))
...
class In {
  ...
  parseColor(e) {
    ...
    return t || (t = this._parseColorCache[e] = F.parse(e)), t;
  }
}
class St {
  ...
  _parse(e, t) {
    ...
    if (Array.isArray(e)) {
      ...
      if (o) {
        ...
        if (!(i instanceof $e) && i.type.kind !== "resolvedImage" && this._isConstant(i)) {
          const s = new In();
          try {
            i = new $e(i.type, i.evaluate(s));
          } catch (l) {
  ...
  concat(e, t, n) {
    ...
    return new St(this.registry, this._isConstant, a, t || null, o, this.errors);
  }
  /**
...
class ar {
  ...
  static parse(e, t) {
    ...
    const n = t.parse(e[1], 1, g), a = t.parse(e[2], 2, W(t.expectedType || C));
    if (!n || !a)
      return null;
    const o = a.type;
...
class or {
  constructor(e, t) {
    this.type = L, this.needle = e, this.haystack = t;
  }
  static parse(e, t) {
    if (e.length !== 3)
      return t.error(`Expected 2 arguments, but found ${e.length - 1} instead.`);
    const n = t.parse(e[1], 1, C), a = t.parse(e[2], 2, C);
    return !n || !a ? null : rr(n.type, [L, A, g, ht, C]) ? new or(n, a) : t.error(`Expected first argument to be of type boolean, string, number or null, but found ${N(n.type)} instead`);
  }
  evaluate(e) {
    const t = this.needle.evaluate(e), n = this.haystack.evaluate(e);
    if (!n)
      return !1;
    if (!Se(t, ["boolean", "string", "number", "null"]))
      throw new D(`Expected first argument to be of type boolean, string, number or null, but found ${N(j(t))} instead.`);
    if (!Se(n, ["string", "array"]))
      throw new D(`Expected second argument to be of type array or string, but found ${N(j(n))} instead.`);
...
class st {
  ...
  evaluate(e) {
    ...
    if (!Se(t, ["boolean", "string", "number", "null"]))
      throw new D(`Expected first argument to be of type boolean, string, number or null, but found ${N(j(t))} instead.`);
    let a;
    if (this.fromIndex && (a = this.fromIndex.evaluate(e)), Se(n, ["string"])) {
...
class lt {
  ...
  evaluate(e) {
    ...
    let a;
    if (this.endIndex && (a = this.endIndex.evaluate(e)), Se(t, ["string"]))
      return [...t].slice(n, a).join("");
    if (Se(t, ["array"]))
      return t.slice(n, a);
    throw new D(`Expected first argument to be of type array or string, but found ${N(j(t))} instead.`);
  }
  eachChild(e) {
...
var Li = /* @__PURE__ */ xi(ki);
function xe(r, e, t) {
  return r + t * (e - r);
}
function Ci(r, e, t, n = "rgb") {
  switch (n) {
    case "rgb": {
      const [a, o, i, s] = ut(r.rgb, e.rgb, t);
      return new F(a, o, i, s, !1);
    }
    case "hcl": {
      ...
      if (!isNaN(a) && !isNaN(l)) {
        let b = l - a;
        l > a && b > 180 ? b -= 360 : l < a && a - l > 180 && (b += 360), y = a + t * b;
      } else isNaN(a) ? isNaN(l) ? y = NaN : (y = l, (i === 1 || i === 0) && (f = u)) : (y = a, (c === 1 || c === 0) && (f = o));
      const [d, m, v, w] = hi([
        y,
        f ?? xe(o, u, t),
        xe(i, c, t),
      ...
      return new F(d, m, v, w, !1);
    }
    case "lab": {
      const [a, o, i, s] = An(ut(r.lab, e.lab, t));
      return new F(a, o, i, s, !1);
    }
  }
}
function ut(r, e, t) {
  return r.map((n, a) => xe(n, e[a], t));
}
function Ai(r, e, t) {
...
const Dt = {
  ...
  array: ut,
  padding: Ai,
  variableAnchorOffsetCollection: Ti
};
class oe {
  constructor(e, t, n, a, o) {
  ...
  static interpolationFactor(e, t, n, a) {
    ...
    if (e.name === "exponential")
      ...
      o = new Li(i[0], i[1], i[2], i[3]).solve(jt(t, 1, n, a));
    }
    return o;
  }
  static parse(e, t) {
    ...
    return !De(l, g) && !De(l, ne) && !De(l, bt) && !De(l, wt) && !De(l, W(g)) ? t.error(`Type ${N(l)} is not interpolatable.`) : new oe(l, n, a, o, s);
  }
  evaluate(e) {
    const t = this.labels, n = this.outputs;
    if (t.length === 1)
    ...
    if (a >= t[o - 1])
      return n[o - 1].evaluate(e);
    const i = Mn(t, a), s = t[i], l = t[i + 1], u = oe.interpolationFactor(this.interpolation, a, s, l), c = n[i].evaluate(e), p = n[i + 1].evaluate(e);
...
class Ge {
  ...
  static parse(e, t) {
    ...
    return a && o.some((s) => Be(a, s.type)) ? new Ge(C, o) : new Ge(n, o);
  }
  evaluate(e) {
    let t = null, n = 0, a;
...
const Di = Ne("==", Ii, zn), ji = Ne("!=", Mi, $i), qi = Ne("<", Ei, Ri), Ui = Ne(">", zi, Ni), Bi = Ne("<=", _i, Fi), Vi = Ne(">=", Pi, Oi);
class Ct {
  constructor(e, t, n) {
  ...
  static parse(e, t) {
    ...
    const a = t.parse(n["case-sensitive"] === void 0 ? !1 : n["case-sensitive"], 1, L);
    if (!a)
      return null;
    const o = t.parse(n["diacritic-sensitive"] === void 0 ? !1 : n["diacritic-sensitive"], 1, L);
    if (!o)
      return null;
    let i = null;
    return n.locale && (i = t.parse(n.locale, 1, A), !i) ? null : new Ct(a, o, i);
  }
  evaluate(e) {
    ...
    for (let i = 1; i <= e.length - 1; ++i) {
      ...
      if (o && typeof s == "object" && !Array.isArray(s)) {
        ...
        if (s["font-scale"] && (l = t.parse(s["font-scale"], 1, g), !l))
          return null;
        let u = null;
        if (s["text-font"] && (u = t.parse(s["text-font"], 1, W(A)), !u))
          return null;
        let c = null;
...
class pr {
  ...
  static parse(e, t) {
    ...
    return n ? n.type.kind !== "array" && n.type.kind !== "string" && n.type.kind !== "value" ? t.error(`Expected argument of type string or array, but found ${N(n.type)} instead.`) : new pr(n) : null;
  }
  evaluate(e) {
    const t = this.input.evaluate(e);
    if (typeof t == "string")
    ...
    if (Array.isArray(t))
      return t.length;
    throw new D(`Expected value to be of type string or array, but found ${N(j(t))} instead.`);
  }
  eachChild(e) {
    e(this.input);
  }
...
function At(r, e, t, n) {
  ...
  return ts(o, a) === 0 ? !1 : !!(jr(r, e, t, n) && jr(t, n, r, e));
}
function Xi(r, e, t) {
  for (const n of t)
...
function as(r, e) {
  const t = [1 / 0, 1 / 0, -1 / 0, -1 / 0], n = [1 / 0, 1 / 0, -1 / 0, -1 / 0], a = r.canonicalID();
  if (e.type === "Polygon") {
    const o = dr(e.coordinates, n, a), i = Ur(r.geometry(), t, n, a);
    if (!He(t, n))
      return !1;
    for (const s of i)
      if (!Pn(s, o))
  ...
  if (e.type === "MultiPolygon") {
    const o = $n(e.coordinates, n, a), i = Ur(r.geometry(), t, n, a);
    if (!He(t, n))
      return !1;
    for (const s of i)
      if (!es(s, o))
...
class ke {
  constructor(e, t) {
    this.type = L, this.geojson = e, this.geometries = t;
  }
  static parse(e, t) {
    if (e.length !== 2)
...
const ss = 6378.137, Br = 1 / 298.257223563, Vr = Br * (2 - Br), Gr = Math.PI / 180;
class yr {
  constructor(e) {
    const t = Gr * ss * 1e3, n = Math.cos(e * Gr), a = 1 / (1 - Vr * (1 - n * n)), o = Math.sqrt(a);
    this.kx = t * o * n, this.ky = t * o * a * (1 - Vr);
  }
  /**
    ...
    for (let l = 0, u = s.length, c = u - 1; l < u; c = l++) {
      ...
      for (const f of e)
        for (let d = 0, m = f.length, v = m - 1; d < m; v = d++) {
          ...
          if (At(p, y, w, b))
            return 0;
          i = Math.min(i, hr(p, y, w, b, t));
        }
    }
  return i;
}
function Wr(r, e, t, n, a, o) {
  if (!o)
    return;
...
function pt(r, e, t, n, a = 1 / 0) {
  ...
  if (o === 0)
    return o;
  const i = new Nn([[0, [0, r.length - 1], [0, 0]]], Fn), s = Xt(t);
  for (; i.length > 0; ) {
    const l = i.pop();
    if (l[0] >= o)
      continue;
    const u = l[1], c = e ? Zt : Wt;
    if (ct(u) <= c) {
      if (!pe(u, r.length))
        return NaN;
      if (e) {
      ...
      const p = Jt(u, e);
      Wr(i, o, n, r, s, p[0]), Wr(i, o, n, r, s, p[1]);
    }
  }
  return o;
}
function ft(r, e, t, n, a, o = 1 / 0) {
  ...
  if (i === 0)
    return i;
  const s = new Nn([[0, [0, r.length - 1], [0, t.length - 1]]], Fn);
  for (; s.length > 0; ) {
    const l = s.pop();
    if (l[0] >= i)
      continue;
    const u = l[1], c = l[2], p = e ? Zt : Wt, y = n ? Zt : Wt;
    if (ct(u) <= p && ct(c) <= y) {
      ...
      if (e && n)
        ...
        for (let m = c[0]; m <= c[1]; ++m)
          if (f = we(t[m], d, a), i = Math.min(i, f), i === 0)
            return i;
      } else if (!e && n) {
        const d = t.slice(c[0], c[1] + 1);
        for (let m = u[0]; m <= u[1]; ++m)
          if (f = we(r[m], d, a), i = Math.min(i, f), i === 0)
            return i;
      } else
...
function ms(r, e) {
  ...
  if (t.length === 0 || t[0].length === 0)
    return NaN;
  const n = os(t).map((i) => i.map((s) => s.map((l) => fr([l.x, l.y], r.canonical)))), a = new yr(n[0][0][0][1]);
  let o = 1 / 0;
  for (const i of e)
    for (const s of n) {
      switch (i.type) {
...
class Le {
  ...
  static parse(e, t) {
    ...
    if (Ve(e[1])) {
      const n = e[1];
      if (n.type === "FeatureCollection")
        return new Le(n, n.features.map((a) => qt(a.geometry)).flat());
      if (n.type === "Feature")
        return new Le(n, qt(n.geometry));
      if ("type" in n && "coordinates" in n)
        return new Le(n, qt(n));
    }
...
class ee {
  ...
  static parse(e, t) {
    ...
    let l = null;
    for (const [u, c] of s) {
      l = new St(t.registry, dt, t.path, null, t.scope);
      const p = [];
      let y = !1;
    ...
    if (s.length === 1)
      ...
      const c = (s.length ? s : i).map(([y]) => gs(y)).join(" | "), p = [];
...
function Zr(r, [e, t, n, a]) {
  ...
  const o = a ? a.evaluate(r) : 1, i = Tn(e, t, n, o);
  if (i)
    throw new D(i);
...
function dt(r) {
  ...
  return r.eachChild((n) => {
    e ? t = t && dt(n) : t = t && n instanceof $e;
  }), t ? Tt(r) && It(r, ["zoom", "heatmap-density", "line-progress", "accumulated", "is-supported-script"]) : !1;
}
function Tt(r) {
  if (r instanceof ee) {
  ...
  if (r instanceof ke || r instanceof Le)
    return !1;
  let e = !0;
...
class vs {
  constructor(e, t) {
    this.expression = e, this._warningHistory = {}, this._evaluator = new In(), this._defaultValue = t ? Ss(t) : null, this._enumValues = t && t.type === "enum" ? t.values : null;
  }
...
function qn(r, e) {
  ...
  return n ? Qt(new vs(n, e)) : Ee(t.errors);
}
class Yr {
  constructor(e, t) {
...
function bs(r, e) {
  ...
  if (!a && !yt(e))
    return Ee([new re("", "data expressions not supported")]);
  const o = It(n, ["zoom"]);
  if (!o && !On(e))
    return Ee([new re("", "zoom expressions not supported")]);
  const i = at(n);
  if (!i && !o)
    return Ee([new re("", '"zoom" expression may only be used as input to a top-level "step" or "interpolate" expression.')]);
  if (i instanceof re)
    return Ee([i]);
  if (i instanceof oe && !Dn(e))
    return Ee([new re("", '"interpolate" expressions cannot be used with this property')]);
  if (!i)
    return Qt(a ? new Yr("constant", t.value) : new Yr("source", t.value));
  const s = i instanceof oe ? i.interpolation : void 0;
  return Qt(a ? new Xr("camera", t.value, i.labels, s) : new Xr("composite", t.value, i.labels, s));
}
function at(r) {
  let e = null;
  if (r instanceof xt)
    ...
    for (const t of r.args)
      if (e = at(t), e)
        break;
  } else (r instanceof Lt || r instanceof oe) && r.input instanceof ee && r.input.name === "zoom" && (e = r);
...
function ws(r) {
  ...
  return r.type === "array" ? W(e[r.value] || C, r.length) : e[r.type];
}
function Ss(r) {
...
function Vn(r) {
  ...
  let n, a = {}, o, i;
  const s = t !== "categorical" && r.value.property === void 0, l = !s, u = z(r.value.stops) === "array" && z(r.value.stops[0]) === "array" && z(r.value.stops[0][0]) === "object", c = J({
    key: r.key,
    value: r.value,
  ...
  return t === "identity" && s && c.push(new h(r.key, r.value, 'missing required property "property"')), t !== "identity" && !r.value.stops && c.push(new h(r.key, r.value, 'missing required property "stops"')), t === "exponential" && r.valueSpec.expression && !Dn(r.valueSpec) && c.push(new h(r.key, r.value, "exponential functions not supported")), r.styleSpec.$version >= 8 && (l && !yt(r.valueSpec) ? c.push(new h(r.key, r.value, "property functions not supported")) : s && !On(r.valueSpec) && c.push(new h(r.key, r.value, "zoom functions not supported"))), (t === "categorical" || u) && r.value.property === void 0 && c.push(new h(r.key, r.value, '"property" property is required')), c;
  function p(m) {
    if (t === "identity")
      return [new h(m.key, m.value, 'identity function may not have a "stops" property')];
    let v = [];
    const w = m.value;
    return v = v.concat(br({
      key: m.key,
      value: w,
    ...
    })), z(w) === "array" && w.length === 0 && v.push(new h(m.key, w, "array must have at least one stop")), v;
  }
  function y(m) {
    let v = [];
    const w = m.value, b = m.key;
    if (z(w) !== "array")
      return [new h(b, w, `array expected, ${z(w)} found`)];
    if (w.length !== 2)
      return [new h(b, w, `array length 2 expected, length ${w.length} found`)];
    if (u) {
      if (z(w[0]) !== "object")
        return [new h(b, w, `object expected, ${z(w[0])} found`)];
      if (w[0].zoom === void 0)
      ...
      O(w[0].zoom) !== i && (i = O(w[0].zoom), o = void 0, a = {}), v = v.concat(J({
        key: `${b}[0]`,
        value: w[0],
        valueSpec: { zoom: {} },
        validateSpec: m.validateSpec,
    ...
    return jn(Te(w[1])) ? v.concat([new h(`${b}[1]`, w[1], "expressions are not allowed in function stops.")]) : v.concat(m.validateSpec({
      key: `${b}[1]`,
      value: w[1],
      valueSpec: e,
      validateSpec: m.validateSpec,
  ...
  function f(m, v) {
    const w = z(m.value), b = O(m.value), T = m.value !== null ? m.value : v;
    if (!n)
      n = w;
    else if (w !== n)
    ...
    if (w !== "number" && t !== "categorical") {
      ...
      return yt(e) && t === void 0 && (R += '\nIf you intended to use a categorical function, specify `"type": "categorical"`.'), [new h(m.key, T, R)];
    }
  ...
  switch (o = o.concat(We({
    ...
    case "!in":
      ...
      for (let i = 2; i < e.length; i++)
        a = z(e[i]), O(e[1]) === "$type" ? o = o.concat(We({
          key: `${t}[${i}]`,
          value: e[i],
...
function Hn(r, e) {
  ...
  let p;
  if (z(i) === "string" && yt(c) && !c.tokens && (p = /^{([^}]+)}$/.exec(i)))
...
Use an identity property function instead: \`{ "type": "identity", "property": ${JSON.stringify(p[1])} }\`.`)];
  const y = [];
  return r.layerType === "symbol" && (s === "text-field" && a && !a.glyphs && y.push(new h(t, i, 'use of "text-field" requires a style "glyphs" property')), s === "text-font" && vr(Te(i)) && O(i.type) === "identity" && y.push(new h(t, i, '"text-font" does not support identity functions'))), y.concat(n({
    key: r.key,
    value: i,
    valueSpec: c,
    style: a,
...
function Ls(r) {
  ...
  const c = O(n.encoding) === "custom", p = ["redFactor", "greenFactor", "blueFactor", "baseShift"], y = r.value.encoding ? `"${r.value.encoding}"` : "Default";
  for (const f in n)
...
function Cs({ key: r, value: e }) {
  if (z(e) === "string")
    return Ie({ key: r, value: e });
  {
    const t = [];
    for (const n in e)
      t.push(...Ie({ key: `${r}.${n}`, value: e[n] }));
    return t;
  }
}
function Yn(r) {
...
const en = {
  ...
  resolvedImage: Ts,
  padding: Is,
  variableAnchorOffsetCollection: Ms,
  sprite: ea
};
function Ue(r) {
  const e = r.value, t = r.valueSpec, n = r.styleSpec;
  return r.validateSpec = Ue, t.expression && vr(O(e)) ? Vn(r) : t.expression && jn(Te(e)) ? Re(r) : t.type && en[t.type] ? en[t.type](r) : J(it({}, r, {
    valueSpec: t.type ? n[t.type] : t
  }));
}
function ta(r) {
  const e = r.value, t = r.key, n = Ie(r);
...
Y.layer = le(se(Zn));
Y.filter = le(se(Sr));
Y.paintProperty = le(se(Kn));
Y.layoutProperty = le(se(Wn));
function se(r) {
  return function(e) {
    return r({
      ...e,
...
function le(r) {
  return function(...e) {
    return ra(r.apply(this, e));
  };
}
function tn(r) {
  if (!r)
    return {
      style: je[Pt[0].referenceStyleID].getDefaultVariant().getExpandedStyleURL(),
  ...
  if (typeof r == "string") {
    ...
    return t.isValidStyle ? {
      ...
      // default styles don't require URL monitoring
      isFallback: !0
    } : r.startsWith("http") ? { style: r, requiresUrlMonitoring: !0, isFallback: !1 } : r.toLowerCase().includes(".json") ? { style: zs(r), requiresUrlMonitoring: !0, isFallback: !1 } : { style: Ta(r), requiresUrlMonitoring: !0, isFallback: !1 };
  }
  return r instanceof Ia ? { style: r.getExpandedStyleURL(), requiresUrlMonitoring: !1, isFallback: !1 } : r instanceof Ma ? {
...
class Ps {
  ...
  onAdd(e) {
    return this._map = e, this._container = ze("div", "maplibregl-ctrl maplibregl-ctrl-group"), this._terrainButton = ze("button", "maplibregl-ctrl-terrain", this._container), ze("span", "maplibregl-ctrl-icon", this._terrainButton).setAttribute("aria-hidden", "true"), this._terrainButton.type = "button", this._terrainButton.addEventListener("click", this._toggleTerrain), this._updateTerrainIcon(), this._map.on("terrain", this._updateTerrainIcon), this._container;
  }
  onRemove() {
...
const rn = S.Marker, nn = S.LngLat, Rs = S.LngLatBounds;
class Ns extends bo {
  constructor() {
    super(...arguments);
    M(this, "lastUpdatedCenter", new nn(0, 0));
    /**
    ...
    M(this, "_updateCamera", (t) => {
      ...
      s > (((p = (c = this.options) == null ? void 0 : c.fitBoundsOptions) == null ? void 0 : p.maxZoom) ?? 30) && (i.zoom = s), this._map.fitBounds(Rs.fromLngLat(n, a), i, {
        geolocateSource: !0
    ...
    M(this, "_finishSetupUI", (t) => {
      if (this._map) {
        ...
        this.options.trackUserLocation && (this._geolocateButton.setAttribute("aria-pressed", "false"), this._watchState = "OFF"), this.options.showUserLocation && (this._dotElement = ze("div", "maplibregl-user-location-dot"), this._userLocationDotMarker = new rn({ element: this._dotElement }), this._circleElement = ze("div", "maplibregl-user-location-accuracy-circle"), this._accuracyCircleMarker = new rn({
...
class Bt {
  constructor(e, t) {
    ...
    }), e.lockZoom !== void 0 && (I(this, G).minZoom = e.lockZoom, I(this, G).maxZoom = e.lockZoom);
  }
  setStyle(e, t) {
    I(this, K) || this.map.setStyle(e, t), V(this, q, Z).call(this);
  }
  addLayer(e, t) {
    return I(this, K) || this.map.addLayer(e, t), V(this, q, Z).call(this), this.map;
  }
  moveLayer(e, t) {
    return I(this, K) || this.map.moveLayer(e, t), V(this, q, Z).call(this), this.map;
  }
  removeLayer(e) {
    return I(this, K) || this.map.removeLayer(e), V(this, q, Z).call(this), this;
  }
  setLayerZoomRange(e, t, n) {
    return I(this, K) || this.map.setLayerZoomRange(e, t, n), V(this, q, Z).call(this), this;
  }
  setFilter(e, t, n) {
    return I(this, K) || this.map.setFilter(e, t, n), V(this, q, Z).call(this), this;
  }
  setPaintProperty(e, t, n, a) {
    return I(this, K) || this.map.setPaintProperty(e, t, n, a), V(this, q, Z).call(this), this;
  }
  setLayoutProperty(e, t, n, a) {
    return I(this, K) || this.map.setLayoutProperty(e, t, n, a), V(this, q, Z).call(this), this;
  }
  setGlyphs(e, t) {
    return I(this, K) || this.map.setGlyphs(e, t), V(this, q, Z).call(this), this;
  }
  onAdd(e) {
    ve(this, X, e), ve(this, de, ze("div", "maplibregl-ctrl maplibregl-ctrl-group"));
    for (const [t, n] of Object.entries(I(this, G).containerStyle))
      I(this, de).style.setProperty(t, n);
    return I(this, G).container = I(this, de), I(this, G).zoom = e.getZoom() + I(this, G).zoomAdjust, this.map = new Os(I(this, G)), this.map.once("style.load", () => {
      this.map.resize();
    }), this.map.once("load", () => {
      V(this, q, na).call(this, I(this, G).parentRect), ve(this, Ze, V(this, q, aa).call(this));
    }), I(this, de);
  }
  onRemove() {
    var e;
    (e = I(this, Ze)) == null || e.call(this), gn(I(this, de));
  }
}
G = new WeakMap(), X = new WeakMap(), de = new WeakMap(), ye = new WeakMap(), K = new WeakMap(), Ze = new WeakMap(), q = new WeakSet(), na = function(e) {
  ...
  if (I(this, ye) === void 0) return;
  const { devicePixelRatio: e } = window, t = I(this, X).getCanvas(), n = t.width / e, a = t.height / e, o = I(this, X).unproject.bind(I(this, X)), i = o([0, 0]), s = o([n, 0]), l = o([0, a]), u = o([n, a]);
  I(this, ye).geometry.coordinates = [
    [l.toArray(), u.toArray(), s.toArray(), i.toArray(), l.toArray()]
  ], this.map.getSource("parentRect").setData(I(this, ye));
}, aa = function() {
  const { pitchAdjust: e } = I(this, G), t = () => {
    i("parent");
  }, n = () => {
    i("minimap");
  }, a = () => {
    I(this, X).on("move", t), this.map.on("move", n);
  }, o = () => {
    I(this, X).off("move", t), this.map.off("move", n);
  }, i = (s) => {
    o();
    const l = s === "parent" ? I(this, X) : this.map, u = s === "parent" ? this.map : I(this, X), c = l.getCenter(), p = l.getZoom() + I(this, G).zoomAdjust * (s === "parent" ? 1 : -1), y = l.getBearing(), f = l.getPitch();
    u.jumpTo({
      center: c,
      zoom: p,
      bearing: y,
      pitch: e ? f : 0
    }), V(this, q, Z).call(this), a();
  };
  return a(), () => {
    o();
  };
...
class Os extends S.Map {
  constructor(t) {
    lo(t.container), t.apiKey && (U.apiKey = t.apiKey);
    ...
    const l = {
      ...
      style: n,
      maplibreLogo: !1,
      transformRequest: Pr(t.transformRequest),
    ...
    M(this, "originalLabelStyle", new window.Map());
    M(this, "isStyleLocalized", !1);
    ...
    ), U.caching && Ht && no(), typeof t.language > "u")
      this.primaryLanguage = U.primaryLanguage;
    else {
      const d = Tr(t.language, E);
      this.primaryLanguage = d ?? U.primaryLanguage;
    }
    this.forceLanguageUpdate = !(this.primaryLanguage === E.STYLE || this.primaryLanguage === E.STYLE_LOCK), this.languageAlwaysBeenStyle = this.primaryLanguage === E.STYLE, this.terrainExaggeration = t.terrainExaggeration ?? this.terrainExaggeration, this.once("styledata", async () => {
      if (!t.geolocate || t.center || t.hash && i)
        return;
      try {
        if (t.geolocate === Fs.COUNTRY) {
      ...
      try {
        ...
        v.searchParams.has("key") || v.searchParams.append("key", U.apiKey), d = await (await fetch(v.href)).json();
      } catch {
      }
      if (t.forceNoAttributionControl !== !0)
        if ("logo" in d && d.logo) {
          const m = d.logo;
          this.addControl(new Rr({ logoURL: m }), t.logoPosition);
        } else t.maptilerLogo && this.addControl(new Rr(), t.logoPosition);
      if (t.scaleControl) {
        const m = t.scaleControl === !0 || t.scaleControl === void 0 ? "bottom-right" : t.scaleControl, v = new So({ unit: U.unit });
        this.addControl(v, m), U.on("unit", (w) => {
          v.setUnit(w);
        });
      }
      if (t.navigationControl !== !1) {
        const m = t.navigationControl === !0 || t.navigationControl === void 0 ? "top-right" : t.navigationControl;
        this.addControl(new $s(), m);
      }
  ...
  getStyleLanguage() {
    return !this.style.stylesheet.metadata || typeof this.style.stylesheet.metadata != "object" ? null : "maptiler:language" in this.style.stylesheet.metadata && typeof this.style.stylesheet.metadata["maptiler:language"] == "string" ? Ea(this.style.stylesheet.metadata["maptiler:language"]) : null;
  }
  /**
  ...
  setPrimaryLanguage(t) {
    const n = this.getStyleLanguage(), a = Tr(t, E);
    if (!a) {
      console.warn(`The language "${a}" is not supported.`);
      return;
    }
    if (!(a.flag === E.STYLE.flag && n && (n.flag === E.AUTO.flag || n.flag === E.VISITOR.flag)) && (a.flag !== E.STYLE.flag && (this.languageAlwaysBeenStyle = !1), this.languageAlwaysBeenStyle || this.primaryLanguage === a && !this.forceLanguageUpdate))
      return;
    if (this.primaryLanguage.flag === E.STYLE_LOCK.flag) {
      console.warn(
    ...
    o.flag === E.VISITOR.flag ? (i = Mr().flag, s = [
      "case",
      ["all", ["has", i], ["has", E.LOCAL.flag]],
      [
        "case",
        ["==", ["get", i], ["get", E.LOCAL.flag]],
        ["get", E.LOCAL.flag],
        [
          "format",
          ["get", i],
...
`,
      ...
      ["get", E.LOCAL.flag]
    ]) : o.flag === E.VISITOR_ENGLISH.flag ? (i = E.ENGLISH.flag, s = [
      "case",
      ["all", ["has", i], ["has", E.LOCAL.flag]],
      [
        "case",
...
`,
      ...
      ["get", E.LOCAL.flag]
    ]) : o.flag === E.AUTO.flag ? (i = Mr().flag, s = ["coalesce", ["get", i], ["get", E.LOCAL.flag]]) : o === E.LOCAL ? (i = E.LOCAL.flag, s = ["get", i]) : (i = o.flag, s = ["coalesce", ["get", i], ["get", E.LOCAL.flag]]);
    ...
    for (const c of l) {
      ...
      if (!y || !("url" in y && typeof y.url == "string") || new URL(y.url).host !== H.maptilerApiHost)
        continue;
      ...
      if (u ? (v = this.getLayoutProperty(d, "text-field"), this.originalLabelStyle.set(d, v)) : v = this.originalLabelStyle.get(d), typeof v == "string") {
        const { contains: w, exactMatch: b } = po(v, this.isStyleLocalized);
        if (!w) continue;
        if (b)
          this.setLayoutProperty(d, "text-field", s);
        else {
          const T = fo(v, s, this.isStyleLocalized);
          this.setLayoutProperty(d, "text-field", T);
        }
      } else {
        const w = co(v, s, this.isStyleLocalized);
  ...
  getCameraHash() {
    ...
    return t[0] = n.lng, t[1] = n.lat, t[2] = this.getZoom(), t[3] = this.getPitch(), t[4] = this.getBearing(), Pa.fromUint8Array(new Uint8Array(t.buffer));
  }
  /**
  ...
  setTransformRequest(t) {
    return super.setTransformRequest(Pr(t)), this;
  }
}
function xr(r) {
...
function ia(r) {
  ...
  for (const i of Array.from(a))
    o.features.push(Vs(i));
  return o;
}
function sa(r, e) {
  let t = r;
  if (typeof t == "string" && (t = xr(t)), !oa(t, "kml"))
  ...
  for (const c of Array.from(u)) {
    ...
    for (const f of Array.from(p))
      y[_(k(f, "key")) ?? ""] = _(k(f, "styleUrl"));
    i[`#${Ce(c, "id")}`] = y;
  }
  for (const c of Array.from(s))
    n.features = n.features.concat(qs(c, a, o, i));
  return n;
}
function on(r) {
    ...
    if (n = B(r, e[a]), n) {
      for (o = 0; o < n.length; o++)
        if (t = n[o], e[a] === "Point")
          s.push({
            type: "Point",
            coordinates: pa(_(k(t, "coordinates")) ?? "")
          });
        else if (e[a] === "LineString")
          s.push({
            type: "LineString",
            coordinates: un(_(k(t, "coordinates")) ?? "")
          });
        else if (e[a] === "Polygon") {
          const u = B(t, "LinearRing"), c = [];
          for (i = 0; i < u.length; i++)
            c.push(un(_(k(u[i], "coordinates")) ?? ""));
          s.push({
            type: "Polygon",
            coordinates: c
          });
...
function qs(r, e, t, n) {
  const a = ot(r), o = {}, i = _(k(r, "name")), s = _(k(r, "address")), l = _(k(r, "description")), u = k(r, "TimeSpan"), c = k(r, "TimeStamp"), p = k(r, "ExtendedData"), y = k(r, "visibility");
  let f, d = _(k(r, "styleUrl")), m = k(r, "LineStyle"), v = k(r, "PolyStyle");
  ...
  if (c !== null && (o.timestamp = _(k(c, "when")) ?? (/* @__PURE__ */ new Date()).toISOString()), m !== null) {
    const b = on(_(k(m, "color"))), T = b[0], R = b[1], $ = Number.parseFloat(_(k(m, "width")) ?? "");
    T && (o.stroke = T), Number.isNaN(R) || (o["stroke-opacity"] = R), Number.isNaN($) || (o["stroke-width"] = $);
  }
  if (v) {
    const b = on(_(k(v, "color"))), T = b[0], R = b[1], $ = _(k(v, "fill")), te = _(k(v, "outline"));
    T && (o.fill = T), Number.isNaN(R) || (o["fill-opacity"] = R), $ && (o["fill-opacity"] = $ === "1" ? o["fill-opacity"] || 1 : 0), te && (o["stroke-opacity"] = te === "1" ? o["stroke-opacity"] || 1 : 0);
  }
  if (p) {
  ...
  y !== null && (o.visibility = _(y) ?? ""), a.coordTimes.length !== 0 && (o.coordTimes = a.coordTimes.length === 1 ? a.coordTimes[0] : a.coordTimes);
  const w = {
    type: "Feature",
...
function pa(r) {
  return ca(r.replace(/\s*/g, "").split(","));
}
function un(r) {
  const e = r.replace(/^\s*|\s*$/g, "").split(/\s+/), t = [];
  for (const n of e) t.push(pa(n));
  return t;
}
function fa(r) {
...
async function Ws(r, e = {}) {
  const t = e.download ?? !1, n = await Zs(r);
  if (t) {
...
function tl(r, e) {
  ...
  const t = e.sourceId ?? Mt(), n = e.layerId ?? Et(), a = {
    polylineLayerId: n,
  ...
  const o = e.lineWidth ?? 3, i = e.lineColor ?? Lr(), s = e.lineOpacity ?? 1, l = e.lineBlur ?? 0, u = e.lineGapWidth ?? 0;
...
function rl(r, e) {
  ...
  if (e.data && !r.getSource(t)) {
    let m = e.data;
    typeof m == "string" && mt(m) && (m = `https://api.maptiler.com/data/${m}/features.json?key=${U.apiKey}`), r.addSource(t, {
      type: "geojson",
      data: m
    });
  }
  let o = e.outlineDashArray ?? null;
  const i = e.outlineWidth ?? 1, s = e.outlineColor ?? "#FFFFFF", l = e.outlineOpacity ?? 1, u = e.outlineBlur ?? 0, c = e.fillColor ?? Lr(), p = e.fillOpacity ?? 1, y = e.outlinePosition ?? "center", f = e.pattern ?? null;
  ...
  const d = (m = null) => {
    if (r.addLayer(
      ...
      let v;
      y === "inside" ? typeof i == "number" ? v = 0.5 * i : v = P(
        i.map(({ zoom: w, value: b }) => ({
          zoom: w,
          value: 0.5 * b
        }))
      ) : y === "outside" ? typeof i == "number" ? v = -0.5 * i : v = P(
        i.map((w) => ({
          zoom: w.zoom,
          value: -0.5 * w.value
        }))
  ...
  }).catch((m) => (console.error("Could not load the pattern image.", m.message), d())) : d(), a;
}
function nl(r, e) {
  if (e.layerId && r.getLayer(e.layerId))
    throw new Error(`A layer already exists with the layer id: ${e.layerId}`);
  const t = e.minPointRadius ?? 10, n = e.maxPointRadius ?? 50, a = e.cluster ?? !1, o = 20, i = Array.isArray(e.pointColor) ? e.pointColor : da.TURBO.scale(10, e.cluster ? 1e4 : 1e3).resample("ease-out-square"), s = i.getBounds(), l = e.sourceId ?? Mt(), u = e.layerId ?? Et(), c = e.showLabel ?? a, p = e.alignOnViewport ?? !0, y = e.outline ?? !1, f = e.outlineOpacity ?? 1, d = e.outlineWidth ?? 1, m = e.outlineColor ?? "#FFFFFF";
  let v;
  const w = e.zoomCompensation ?? !0, b = e.minzoom ?? 0, T = e.maxzoom ?? 23;
  typeof e.pointOpacity == "number" ? v = e.pointOpacity : Array.isArray(e.pointOpacity) ? v = P(e.pointOpacity) : e.cluster ? v = yn(i, "point_count") : e.property ? v = yn(i, e.property) : v = P([
    { zoom: b, value: 0 },
    { zoom: b + 0.25, value: 1 },
    { zoom: T - 0.25, value: 1 },
    { zoom: T, value: 0 }
  ...
  if (e.data && !r.getSource(l)) {
    let $ = e.data;
    typeof $ == "string" && mt($) && ($ = `https://api.maptiler.com/data/${$}/features.json?key=${U.apiKey}`), r.addSource(l, {
      type: "geojson",
      data: $,
      cluster: a
    });
  ...
  if (a) {
    ...
    const $ = Array.from({ length: o }, (te, ge) => {
    ...
    r.addLayer(
      {
        ...
        paint: {
          ...
          "circle-color": typeof e.pointColor == "string" ? e.pointColor : fn($, "point_count"),
          "circle-radius": typeof e.pointRadius == "number" ? e.pointRadius : Array.isArray(e.pointRadius) ? P(e.pointRadius) : dn($, "point_count", !1),
    ...
    ), r.addLayer(
      {
        ...
        paint: {
          ...
          "circle-radius": typeof e.pointRadius == "number" ? e.pointRadius : Array.isArray(e.pointRadius) ? P(e.pointRadius) : $[0].pointRadius * 0.75,
          "circle-opacity": v,
          ...y && {
            "circle-stroke-opacity": typeof f == "number" ? f : P(f),
            "circle-stroke-width": typeof d == "number" ? d : P(d),
    ...
    let $ = typeof e.pointColor == "string" ? e.pointColor : Array.isArray(e.pointColor) ? e.pointColor.getColorHex(e.pointColor.getBounds().min) : Lr(), te = typeof e.pointRadius == "number" ? w ? P([
    ...
    if (e.property && Array.isArray(e.pointColor)) {
      ...
      $ = fn(ge, e.property), te = dn(ge, e.property, w);
    }
    r.addLayer(
      {
        id: R.pointLayerId,
  ...
  if (c !== !1 && (e.cluster || e.property)) {
    ...
    const $ = e.labelColor ?? "#fff", te = e.labelSize ?? 12;
    r.addLayer(
      {
        id: R.labelLayerId,
        type: "symbol",
...
function al(r, e) {
  if (e.layerId && r.getLayer(e.layerId))
    throw new Error(`A layer already exists with the layer id: ${e.layerId}`);
  const t = e.sourceId ?? Mt(), n = e.layerId ?? Et(), a = e.minzoom ?? 0, o = e.maxzoom ?? 23, i = e.zoomCompensation ?? !0, s = e.opacity ?? [
    { zoom: a, value: 0 },
    { zoom: a + 0.25, value: 1 },
    { zoom: o - 0.25, value: 1 },
    { zoom: o, value: 0 }
  ];
  let l = Array.isArray(e.colorRamp) ? e.colorRamp : da.TURBO.transparentStart();
  const u = l.getBounds();
  ...
  let f = 1;
  p ? typeof y == "number" ? (f = y, typeof e.weight == "number" && console.warn(
    "The option `.property` is ignored when `.propertyValueWeights` is not of type `PropertyValueWeights`"
  )) : Array.isArray(y) ? f = Ys(y, p) : console.warn(
    "The option `.property` is ignored when `.propertyValueWeights` is not of type `PropertyValueWeights`"
  ...
  let v = 1;
  typeof m == "number" ? v = m : Array.isArray(m) && "zoom" in m[0] ? v = P(m) : p && Array.isArray(m) && "propertyValue" in m[0] ? v = Xs(m, p, i) : !p && Array.isArray(m) && "propertyValue" in m[0] ? (v = P(d), console.warn("The option `.radius` can only be property-driven if the option `.property` is provided.")) : v = P(d);
  const w = {
    heatmapLayerId: n,
    heatmapSourceId: t
  };
  if (e.data && !r.getSource(t)) {
    let b = e.data;
    typeof b == "string" && mt(b) && (b = `https://api.maptiler.com/data/${b}/features.json?key=${U.apiKey}`), r.addSource(t, {
      type: "geojson",
      data: b
    });
  }
...
const $l = S.Map, Rl = S.Marker, Nl = S.Popup, Fl = S.Style, Ol = S.CanvasSource, Dl = S.GeoJSONSource, jl = S.ImageSource, ql = S.RasterTileSource, Ul = S.RasterDEMTileSource, Bl = S.VectorTileSource, Vl = S.VideoSource, Gl = S.NavigationControl, Hl = S.GeolocateControl, Kl = S.AttributionControl, Wl = S.LogoControl, Zl = S.ScaleControl, Jl = S.FullscreenControl, Yl = S.TerrainControl, Xl = S.BoxZoomHandler, Ql = S.ScrollZoomHandler, eu = S.CooperativeGesturesHandler, tu = S.KeyboardHandler, ru = S.TwoFingersTouchPitchHandler, nu = S.MapWheelEvent, au = S.MapTouchEvent, ou = S.MapMouseEvent, iu = S.config, su = S.getVersion, {
  setRTLTextPlugin: lu,
  getRTLTextPluginStatus: uu,
  LngLat: cu,
  LngLatBounds: pu,
  MercatorCoordinate: fu,
  Evented: du,
  AJAXError: yu,
  prewarm: mu,
  clearPrewarmedResources: hu,
  Hash: gu,
  Point: vu,
  EdgeInsets: bu,
  DragRotateHandler: wu,
  DragPanHandler: Su,
  TwoFingersTouchZoomRotateHandler: xu,
  DoubleClickZoomHandler: ku,
  TwoFingersTouchZoomHandler: Lu,
  TwoFingersTouchRotateHandler: Cu,
  getWorkerCount: Au,
  setWorkerCount: Tu,
  getMaxParallelImageRequests: Iu,
  setMaxParallelImageRequests: Mu,
  getWorkerUrl: Eu,
  setWorkerUrl: zu,
  addSourceType: _u,
  importScriptInWorkers: Pu,
  addProtocol: $u,
  removeProtocol: Ru
} = S;
export {
  yu as AJAXError,
  xl as AttributionControl,
  Kl as AttributionControlMLGL,
  Ll as BoxZoomHandler,
  Xl as BoxZoomHandlerMLGL,
  ml as CanvasSource,
  Ol as CanvasSourceMLGL,
  x as ColorRamp,
  da as ColorRampCollection,
  Al as CooperativeGesturesHandler,
  eu as CooperativeGesturesHandlerMLGL,
  ku as DoubleClickZoomHandler,
  Su as DragPanHandler,
  wu as DragRotateHandler,
  bu as EdgeInsets,
  du as Evented,
  xo as FullscreenControl,
  Jl as FullscreenControlMLGL,
  hl as GeoJSONSource,
  Dl as GeoJSONSourceMLGL,
  bo as GeolocateControl,
  Hl as GeolocateControlMLGL,
  Fs as GeolocationType,
  gu as Hash,
  gl as ImageSource,
  ...
  Rr as MaptilerLogoControl,
  $s as MaptilerNavigationControl,
  Ps as MaptilerTerrainControl,
  pl as Marker,
  Rl as MarkerMLGL,
  ...
  Ul as RasterDEMTileSourceMLGL,
  vl as RasterTileSource,
  ql as RasterTileSourceMLGL,
  ju as ReferenceMapStyle,
  So as ScaleControl,
  Zl as ScaleControlMLGL,
  Cl as ScrollZoomHandler,
  Ql as ScrollZoomHandlerMLGL,
  Ya as SdkConfig,
  qu as ServiceError,
  yl as Style,
  Fl as StyleMLGL,
  ...
  Il as TwoFingersTouchPitchHandler,
  ...
  Bl as VectorTileSourceMLGL,
  Sl as VideoSource,
  Vl as VideoSourceMLGL,
  $u as addProtocol,
  _u as addSourceType,
  Uu as areSameLanguages,
  Bu as bufferToPixelDataBrowser,
  ...
  Hu as data,
  Ku as elevation,
  Wu as expandMapStyle,
  Zu as geocoding,
  Ju as geolocation,
  Yu as getAutoLanguage,
  Mr as getBrowserLanguage,
  ...
  Iu as getMaxParallelImageRequests,
  ...
  ic as misc,
  mu as prewarm,
  Ru as removeProtocol,
  Mu as setMaxParallelImageRequests,
